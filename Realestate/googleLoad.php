...
<div style="padding-left: 50px; overflow-y: scroll; height: 100%;">
    <div>
        <h3>Check Price</h3>
        <div>
            <input type="checkbox" name="category" value="school" id="scSchool" data-name="category-school" checked> 200-300(만원)
    ...
    <h3 id="headerSchool" class="categoryHeader">200-300(만원)</h3>
        ...
        $.ajax({
            ...
            success: function(data) { 
                $.each(data, function(i,item) {            
                        ...
                        if(item.price >= 200 && item.price < 300) obj.category = 'school';
